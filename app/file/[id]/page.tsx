...
import { getFile, initDB } from "@/lib/db";
          ...
          <div className="space-y-2 text-sm">
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="text-white">
                © {file.copyright_year} {file.author}
              </span>
            </div>
            <div className="flex items-center justify-between">
          ...
          <div className="mt-4 pt-4 border-t border-gray-800 text-xs text-gray-500 leading-relaxed">
            {file.license === "All-Rights-Reserved" ? (
              ...
              <>
                ...
                <a
                  href={`https://creativecommons.org/licenses/${file.license.toLowerCase().replace("cc-", "").replace("-4.0", "/4.0")}`}
                  target="_blank"
